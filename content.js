...
const PRE_MSG = {
  "Emaily": "",
  "Emaily-respond-email": "Respond to the following email, starting with a proper greeting and ending with a proper closing",
  "Emaily-fix-grammar": "Fix any grammatical errors in the following text:",
  "Emaily-fill-text": "Make a complete sentence or paragraph in the language you detected from this short brief"
};

chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {

  if (!OPENAI_APIKEY) {
    alert('No Open AI API key provided! Please go to Settings.');
  }

  if (message.type.startsWith('Emaily')) {
